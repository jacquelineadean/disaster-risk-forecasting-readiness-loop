...
* **No address, coordinate, tract, block or parcel field.** Not in the
  facility schema, not in a report, not in a review record. The design
  intensity inject 3 needs comes from the planner's own Elevation Certificate
  and is cited as a facility document.
